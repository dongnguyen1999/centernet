...
from centernet_count.metrics import SaveBestMae, TestMae
import os
import numpy as np
...
def train(model, train_df, valid_df, config: Config, test_df=None, generator=DataGenerator):
    ...
    callbacks = [early_stopping, reduce_lr, model_frequently_checkpoint, model_bestloss_checkpoint, save_best_mae, csv_logger]
