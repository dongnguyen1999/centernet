...
def calc_map(eval_result_path, image_path=None, iou_threshold=0.5, plot_result=True, ignore_classes=[], temp_path=".temp_files"):
    ...
    GT_PATH = os.path.join(eval_result_path, 'input', 'ground-truth')
    DR_PATH = os.path.join(eval_result_path, 'input', 'detection-results')
        ...
        for class_index, class_name in enumerate(gt_classes):
            ...
            for idx in trange(len(dr_data)):
                ...
                if show_animation:
                    ...
                    ground_truth_img = glob.glob1(image_path, file_id + ".*")
                    ...
                    if len(ground_truth_img) == 0:
                        ...
                        #print(image_path + "/" + ground_truth_img[0])
                        # Load image
                        img = cv2.imread(image_path + "/" + ground_truth_img[0])
